...
<template>
  <a-row class="footer" type="flex" justify="center" align="middle" :gutter="2">
    ...
    <a-col :xs="24" :sm="8" :md="6" :lg="6" :xl="6">
      <Copyrights color="ghostwhite" :size="1"/><br />
      <a style="color:ghostwhite;" target="_blank" href="https://beian.miit.gov.cn">粤ICP备2020112636号-1</a>
    </a-col>
    <!-- 头像 -->
    <a-col :xs="24" :sm="6" :md="4" :lg="4" :xl="4">
      <a-popover arrowPointAtCenter>
        ...
        <span class="avatar ant-avatar ant-avatar-circle ant-avatar-image">
                    <img alt="VsKendo" draggable="false" src="../assets/vskendo-pure.png"/>
                </span>
      </a-popover>
    </a-col>
    <!-- 社交 -->
    <a-col :xs="24" :sm="8" :md="6" :lg="6" :xl="6">
      <Social color="ghostwhite" :size="1.5"/>
    </a-col>
  </a-row>
</template>
